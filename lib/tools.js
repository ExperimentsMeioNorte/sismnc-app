...
Meteor.getDateHour = function(){
    ...
    Meteor.dateBegin = Session.get('getupDateBegin');
    Meteor.dateEnd = Session.get('getupDateEnd');
    Session.set('getupDateBegin', undefined);
    Session.set('getupDateEnd', undefined);
}
