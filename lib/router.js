Router.configure({
  ...
  waitOn: function (){
    alert('Iniciando o subscribe');
    Meteor.remote.subscribe('program').wait();
    Meteor.remote.subscribe('category').wait();
    Meteor.remote.subscribe('content').wait();
    Meteor.remote.subscribe('answer').wait();
    Meteor.remote.subscribe('poll').wait();
    Meteor.remote.subscribe('polluser').wait();
    Meteor.remote.subscribe('vehicle').wait();
    Meteor.remote.subscribe('user').wait();
    Meteor.remote.subscribe('city').wait();
    Meteor.subscribe('users').wait();
  }
});
